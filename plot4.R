...
par(mfrow = c(2,2))
plot(hpc2[,1], ylab = "Global Active Power (kilowatts)", type = "l", xaxt='n', xlab='')
axis(1,label="Thur", at = 0)
axis(1,label="Fri", at = 1440)
axis(1,label="Sat", at = 2910)
plot(hpc2$Voltage, ylab = "Voltage", xlab = "datetime", , type = "l", xaxt='n')
axis(1,label="Thur", at = 0)
axis(1,label="Fri", at = 1440)
axis(1,label="Sat", at = 2910)
...
plot(hpc2$Global_reactive_power, ylab = "Global_reactive_power", xlab = "datetime",
xaxt = 'n', type = 'l')
axis(1,label="Thur", at = 0)
axis(1,label="Fri", at = 1440)
axis(1,label="Sat", at = 2910)
